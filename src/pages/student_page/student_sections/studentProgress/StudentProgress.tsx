  ...
  return (
    <div className={styles.student_progress}>
      <div className={styles.student_progres_info}>
        <div className="border-b border-[#BEBFE4] text-[#5F6368] pb-1">Ընդհանուր</div>
        ...
        rows={[
          {
            ...
            render: ({}) => (
              <div className="flex items-center gap-2 w-fit mx-auto">
                ...
                <img src={toStudentsPageImg} className="w-[14px] cursor-pointer" alt="" />
              </div>
            ),
          },
          {
          ...
          },
          {
            name: 'Իմ առաջընթացը',
            render: () => (
              <ProgressBar className="w-[300px]" progress={Math.floor(Math.random() * 100)} />
            ),
            tdClassName: '!text-center',
          },
        ]}
        data={[{ title: 'aaaa', date:"ghhghgh" }, {}, {}, {}]}
      />
    </div>
  );
};

const ProgressInfoCard: FC<{ title: string; count: number }> = ({ title, count }) => {
  return (
